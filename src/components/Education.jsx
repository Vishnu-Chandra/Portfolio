...
export default function Education() {
  ...
  return (
    <section id="education" className="px-8 pt-12 pb-20 bg-gradient-to-b from-slate-900 via-gray-850 to-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-gray-400 text-lg">Academic journey and qualifications</p>
        </div>

        {/* Timeline Container - Centered */}
        <div className="relative">
          {/* Timeline vertical line - CENTERED */}
          <div className="absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-purple-500 via-pink-500 to-purple-500"></div>
                ...
                >
                  <div className={`flex items-center gap-8 ${isLeft ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                    ...
                    <div className="flex-1 md:w-[calc(50%-4rem)]">
                      <div className="group bg-gray-800/50 backdrop-blur-sm border-2 border-gray-700 rounded-2xl p-6 transition-all duration-300 hover:border-purple-500 hover:shadow-2xl hover:shadow-purple-500/30 hover:bg-gray-800/70 hover:scale-[1.02]">
                        
                        {/* Logo inside card */}
                        <div className="flex items-start gap-4 mb-4">
                          <div className="w-16 h-16 bg-white rounded-xl p-2 flex items-center justify-center flex-shrink-0 shadow-lg">
                            <img
                              src={edu.logo}
                              alt={edu.alt}
                        ...
                        <div className="border-t border-gray-700 pt-4">
                          ...
                          <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-600/10 border border-purple-500/30 rounded-lg">
                            ...
                            <span className="font-bold text-purple-300 text-sm">Grade: </span>
                    ...
                    <div className="absolute left-1/2 transform -translate-x-1/2 hidden md:block">
                      <div className="relative">
                        {/* Large pulsing ring */}
                        <div className="absolute inset-0 w-20 h-20 -m-2 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 animate-pulse opacity-50"></div>
                        {/* Main dot */}
                        <div className="relative w-16 h-16 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full flex items-center justify-center border-4 border-gray-900 shadow-lg shadow-purple-500/50">
