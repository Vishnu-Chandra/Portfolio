...
export default function Skills() {
  return (
    <section id="skills" className="relative px-8 py-20 bg-gradient-to-b from-gray-900 to-gray-800 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 bg-clip-text text-transparent mb-4 animate-pulse">
            Skills & Technologies
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-purple-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/20 hover:-translate-y-2">
          ...
          {/* Frontend */}
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/20 hover:-translate-y-2">
          ...
          {/* Backend */}
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-green-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-green-500/20 hover:-translate-y-2">
          ...
          {/* Tools & Databases */}
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-pink-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-pink-500/20 hover:-translate-y-2">
            <h3 className="text-xl font-semibold mb-6 text-pink-400 flex items-center gap-2">
...
function Skill({ icon, name, color }) {
  return (
    <div className="group relative flex items-center gap-2 px-4 py-2.5 bg-gray-900/50 border border-gray-700 rounded-xl hover:border-gray-500 transition-all duration-300 hover:scale-110 hover:shadow-lg cursor-pointer">
      <span className={`text-xl ${color} group-hover:scale-125 transition-transform duration-300`}>
        {icon}
      </span>
